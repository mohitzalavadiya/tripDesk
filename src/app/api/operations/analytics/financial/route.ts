...
/**
 * GET /api/operations/analytics/financial
 * Returns internal supplier cost reconciliation analytics & variance breakdown.
 */
export async function GET(request: NextRequest) {
  try {
    ...
    return apiSuccess({
      ...
      overview: dashboard.overview.financialOverview,
    });
  } catch (error) {
