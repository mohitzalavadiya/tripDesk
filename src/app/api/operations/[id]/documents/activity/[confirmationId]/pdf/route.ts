...
/**
 * GET /api/operations/[id]/documents/activity/[confirmationId]/pdf
 * Generates and returns a professional Activity / Excursion Pass PDF.
 */
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const { buffer, filename } =
      await operationsDocumentService.generateActivityVoucher(
        context.agencyId,
        id,
        confirmationId,
