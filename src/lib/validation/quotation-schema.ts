...
export const createQuotationSchema = z.object({
  ...
  markupPercentage: z.number().min(-100, "Markup % cannot be less than -100").max(500, "Markup % cannot exceed 500").default(0).optional(),
  markupAmount: z.number().default(0).optional(),
...
export const updateQuotationSchema = z
  .object({
    ...
    markupPercentage: z.number().min(-100).max(500).optional(),
